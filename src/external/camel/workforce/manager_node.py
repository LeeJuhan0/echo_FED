...
from src.external.camel.agents import ChatAgent
from src.external.camel.messages.base import BaseMessage
from src.external.camel.tasks.task import Task, TaskState
from src.external.camel.workforce.base import BaseNode
from src.external.camel.workforce.single_agent_node import SingleAgentNode
from src.external.camel.workforce.task_channel import TaskChannel
from src.external.camel.workforce.utils import (
    check_if_running,
    parse_assign_task_resp,
    parse_create_node_resp,
)
from src.external.camel.workforce.worker_node import WorkerNode
from src.external.camel.workforce.workforce_prompt import (
    ASSIGN_TASK_PROMPT,
    CREATE_NODE_PROMPT,
)
