...
from src.external.camel.prompts.ai_society import (
    AISocietyPromptTemplateDict,
    TextPromptDict,
)
from src.external.camel.prompts.code import CodePromptTemplateDict
from src.external.camel.prompts.evaluation import (
    EvaluationPromptTemplateDict,
)
from src.external.camel.prompts.generate_text_embedding_data import (
    GenerateTextEmbeddingDataPromptTemplateDict,
)
from src.external.camel.prompts.image_craft import ImageCraftPromptTemplateDict
from src.external.camel.prompts.misalignment import MisalignmentPromptTemplateDict
from src.external.camel.prompts.multi_condition_image_craft import (
    MultiConditionImageCraftPromptTemplateDict,
)
from src.external.camel.prompts.object_recognition import (
    ObjectRecognitionPromptTemplateDict,
)
from src.external.camel.prompts.role_description_prompt_template import (
    RoleDescriptionPromptTemplateDict,
)
from src.external.camel.prompts.solution_extraction import (
    SolutionExtractionPromptTemplateDict,
)
from src.external.camel.prompts.translation import TranslationPromptTemplateDict
from src.external.camel.prompts.video_description_prompt import (
    VideoDescriptionPromptTemplateDict,
)
from src.external.camel.types import TaskType
