...
from src.external.camel.interpreters import BaseInterpreter, SubprocessInterpreter
from src.external.camel.types import RoleType
from src.external.camel.utils import get_system_information
...
class TextPrompt(str):
    ...
    def key_words(self) -> Set[str]:
        ...
        from src.external.camel.utils import get_prompt_template_key_words
