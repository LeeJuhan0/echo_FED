...
from src.external.camel.agents.base import BaseAgent
from src.external.camel.configs import ChatGPTConfig
from src.external.camel.memories import (
    AgentMemory,
    ChatHistoryMemory,
    MemoryRecord,
    ScoreBasedContextCreator,
)
from src.external.camel.messages import BaseMessage, FunctionCallingMessage, OpenAIMessage
from src.external.camel.models import BaseModelBackend, ModelFactory
from src.external.camel.responses import ChatAgentResponse
from src.external.camel.types import (
    ChatCompletion,
    ChatCompletionChunk,
    ModelPlatformType,
    ModelType,
...
from src.external.camel.utils import (
    Constants,
...
if TYPE_CHECKING:
    ...
    from src.external.camel.terminators import ResponseTerminator
    from src.external.camel.toolkits import OpenAIFunction
...
try:
    ...
    from src.external.camel.utils import track_agent
...
class ChatAgent(BaseAgent):
    ...
    def _add_output_schema_to_tool_list(self, output_schema: BaseModel):
        ...
        if self.model_type.is_openai:
            ...
            from src.external.camel.configs.gemini_config import GeminiConfig
