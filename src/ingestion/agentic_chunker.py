...
class AgenticChunker:
    ...
    def _find_relevant_chunk(self, proposition):
        ...
        chunk_found_text = runnable.invoke({
            "proposition": proposition,
        ...
        class ChunkID(BaseModel):
            ...
            chunk_id: Optional[str] = Field(description="The Chunk ID if found, else None")

        structured_llm = self.llm.with_structured_output(ChunkID)

        extraction_found = structured_llm.invoke(chunk_found_text)
