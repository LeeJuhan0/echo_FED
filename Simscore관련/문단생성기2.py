...
def is_near_duplicate(candidate: str, recent: List[str], threshold: float = 0.98) -> bool:
...
def main():
    ...
    parser.add_argument("--fuzzy-threshold", type=float, default=0.98, help="근사 중복 판정 임계값(기본: 0.98)")
